<main>
    ...
    <main>
        ...
        <section class="bg-white py-24">
            <div class="max-w-6xl mx-auto px-6 text-center">
                <h2 class="text-3xl sm:text-5xl font-bold font-bree mb-10">
                    What The Villa Widari 3
                </h2>
                <p class="max-w-8xl mx-auto text-base sm:text-lg leading-relaxed text-gray-800 mb-16">
                    Stay in our Widari Villa 3, designed with the charm of traditional Joglo architecture that brings warmth and serenity. Featuring two comfortable single beds, this room is perfect for friends, family, or travel companions. From your window, enjoy the calming view of lush green rice fields right outside.
                <div class=" h-80 rounded-xl shadow-md overflow-hidden">
                    <img src="{{ asset('images/widari3/2.webp') }}" 
                         alt=""
        ...
        <section class="bg-gray-100 py-20">
            <div class="max-w-6xl mx-auto px-6">
                ...
                <div class="grid md:grid-cols-2 gap-12 items-center">
                    <div>
                        <img src="{{ asset('images/widari3/3.webp') }}" alt="Widari Villa Pool" class="rounded-2xl shadow-lg w-full object-cover">
                    </div>
                    <div>        
                        <p class="text-gray-700 leading-relaxed text-base sm:text-lg text-justify">
                            Experience the comfort of our Joglo-style villa with a warm wooden interior and modern touches. Featuring twin beds, this villa is perfect for friends or travelers who prefer separate sleeping spaces, while still enjoying a peaceful stay surrounded by nature.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <section class="bg-white py-20">
            <div class="max-w-6xl mx-auto px-6">
                <div class="grid md:grid-cols-2 gap-12 items-center">
                    ...
                    <div>
                        <img src="{{ asset('images/widari3/4.webp') }}" alt="Widari Villa Pool" class="rounded-2xl shadow-lg w-full object-cover">
                    </div>
                </div>
            </div>
        </section>
        <section class="bg-gray-100 py-24">
            <div class="max-w-6xl mx-auto px-6 text-center">
                <h2 class="text-2xl sm:text-5xl font-bold font-bree mb-8">
                    Whats Villa Widari 3 Offers
                </h2>
                <p class="max-w-6xl mx-auto text-base sm:text-lg leading-relaxed text-gray-800 mb-10">
                    Experience the charm of Widari Villa 3, inspired by traditional Joglo wooden architecture and surrounded by a warm and peaceful atmosphere. Carefully designed for comfort and relaxation, every detail is crafted to make your stay truly unforgettable. Featuring two comfortable twin beds, this villa is perfect for friends or travelers who prefer separate sleeping spaces while still enjoying a comfortable and tranquil environment.
                <div class="grid md:grid-cols-4 gap-8 text-center">
                    ...
                    <div class="bg-white h-48 rounded-xl shadow-sm border border-gray-100 flex flex-col items-center justify-center space-y-3 hover:scale-105 hover:shadow-lg transition">
                        ...
                        <p class="font-medium">Comfortable Twin Bed</p>
                    </div>
            ...
            <div class="max-w-6xl mx-auto px-6">
                ...
                <div class="swiper myGallery rounded-xl overflow-hidden">
                    <div class="swiper-wrapper">
                        ...
                        @php
                            $images = File::files(public_path('images/widari3'));
                        @endphp
        
                        @foreach ($images as $image)
                            <div class="swiper-slide">
                                <img src="{{ asset('images/widari3/' . $image->getFilename()) }}" 
        ...
        <section class="relative py-16">
            <div class="absolute inset-0">
                <img src="/images/widari3/14.webp" class="w-full h-full object-cover">
        ...
        <section class="py-16 bg-white">
            <div class="max-w-6xl mx-auto px-6">    
                <h2 class="text-center text-3xl font-bree sm:text-5xl font-bold mb-10">
                    Other Villa
                </h2>
    ...
    function heroSlider() {
        return {
            current: 0,
            images: [
                '/images/widari3/2.webp',
                '/images/widari3/14.webp',
                '/images/widari3/12.webp',
                '/images/widari3/1.webp',
                '/images/widari3/3.webp',
                '/images/widari3/4.webp',
            ],
            start() {
                setInterval(() => {
