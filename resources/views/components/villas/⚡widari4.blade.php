<main>
    ...
    <main>
        ...
        <section class="bg-white py-24">
            <div class="max-w-6xl mx-auto px-6 text-center">
                <h2 class="text-3xl sm:text-5xl font-bold font-bree mb-10">
                    What The Villa Widari 4
                </h2>
                <p class="max-w-6xl mx-auto text-base sm:text-lg leading-relaxed text-gray-800 mb-16">
                    Widari Villa 4 offers a beautiful stay inspired by traditional Joglo wooden architecture, creating a warm and authentic atmosphere blended with modern comfort. The elegant wooden interior brings a sense of tranquility, perfect for a relaxing escape in Ubud.Featuring a comfortable double bed and a private bathtub, this villa is designed for guests who seek both comfort and a touch of luxury. Enjoy peaceful moments as you unwind in a serene and cozy environment.
                </p>
                <div class=" h-80 rounded-xl shadow-md overflow-hidden">
                    <img src="{{ asset('images/widari4/2.webp') }}" 
                         alt=""
        ...
        <section class="bg-gray-100 py-20">
            <div class="max-w-6xl mx-auto px-6">
                ...
                <div class="grid md:grid-cols-2 gap-12 items-center">
                    <div>
                        <img src="{{ asset('images/widari4/3.webp') }}" alt="Widari Villa Pool" class="rounded-2xl shadow-lg w-full object-cover">
                    </div>
                    <div>        
                        <p class="text-gray-700 leading-relaxed text-base sm:text-lg text-justify">
                            Relax in a serene Joglo-style villa with warm wooden interiors and modern comforts. Relax in a comfortable double bed and indulge in a soothing soak in the bathtub, creating the perfect moment of relaxation during your stay.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <section class="bg-white py-20">
            <div class="max-w-6xl mx-auto px-6">
                <div class="grid md:grid-cols-2 gap-12 items-center">
                    <div>
                        ...
                        <div class="space-y-4 text-gray-700 text-lg">
                            ...
                            <div class="flex items-center space-x-3 text-gray-700">
                                <svg class="w-5 h-5 text-[#5b2d1a]" fill="none" stroke="currentColor" stroke-width="2">
                                    <path d="M3 10h18M5 10v4a4 4 0 004 4h6a4 4 0 004-4v-4M7 10V6a2 2 0 012-2h2"/>
                                </svg>
                                <p >Bath Tub</p>
                            </div>
                    ...
                    <div>
                        <img src="{{ asset('images/widari4/4.webp') }}" alt="Widari Villa Pool" class="rounded-2xl shadow-lg w-full object-cover">
                    </div>
                </div>
            </div>
        </section>
        <section class="bg-gray-100 py-24">
            <div class="max-w-6xl mx-auto px-6 text-center">
                <h2 class="text-2xl sm:text-5xl font-bold font-bree mb-8">
                    Whats Widari Villa 4 Offers
                </h2>
                <p class="max-w-6xl mx-auto text-base sm:text-lg leading-relaxed text-gray-800 mb-10">
                    Widari Villa 4 offers the perfect blend of traditional Joglo charm and modern comfort. Designed with elegant wooden interiors, the villa creates a warm and peaceful atmosphere for a truly relaxing stay. Featuring a comfortable double bed and private bathtub, guests can enjoy a moment of rest and a touch of luxury. The tranquil setting makes it ideal for couples or travelers seeking privacy, comfort, and an unforgettable experience in Ubud.
                </p>
                <div class="grid md:grid-cols-5 gap-8 text-center">
                    ...
                    <div class="bg-white h-48 rounded-xl shadow-sm border border-gray-100 flex flex-col items-center justify-center space-y-3 hover:scale-105 hover:shadow-lg transition">
                        <i class="fa-solid fa-bath text-3xl text-[#5b2d1a]"></i>
                        <p class="font-medium">Bath Tub</p>
                    </div>
        ...
        <section class="py-16 bg-white">
            <div class="max-w-6xl mx-auto px-6">
                <h2 class="text-center sm:text-5xl text-3xl font-bold font-bree mb-8">
                    Gallery
                </h2>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        @foreach ($images as $image)
                            <div class="swiper-slide">
                                <img src="{{ asset('images/widari4/' . $image->getFilename()) }}" 
        ...
        <section class="relative py-16">
            <div class="absolute inset-0">
                <img src="/images/widari4/2.webp" class="w-full h-full object-cover">
                    ...
                    <form wire:submit.prevent="submit" class="space-y-6">
                        ...
                        <div>
                            ...
                            <small class="text-white/70">
                                Gunakan kode negara (contoh: 628..., 1555..., 447...)
                            </small>
                        </div>
                        <div>
        ...
        <section class="py-16 bg-white">
            <div class="max-w-6xl mx-auto px-6">    
                <h2 class="text-center sm:text-5xl text-3xl font-bree font-bold mb-10">
                    Other Villa
                </h2>
                <div class="grid md:grid-cols-3 gap-6">
                    <a href="/widarivilla1">
                        <div class="relative">
                            <img src="{{ asset('images/widari1/1.webp') }}" class="w-full h-[300px] object-cover rounded-lg">
                            <div class="absolute bottom-4 bg-white px-8 py-3 shadow-lg font-bree">
                                <p class="font-bold">Widari Villa 1</p>
    ...
    function heroSlider() {
        return {
            current: 0,
            images: [
                '/images/widari4/2.webp',
                '/images/widari4/7.webp',
                '/images/widari4/13.webp',
                '/images/widari4/1.webp',
                '/images/widari4/3.webp',
                '/images/widari4/4.webp',
            ],
            start() {
                setInterval(() => {
